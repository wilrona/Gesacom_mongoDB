...
global_role = [
    {"module":"parametre", "valeur": "module_parametre",
        'role':[
            {'titre':'parametrage entreprise', 'valeur':'entreprise', 'action': 1},
            {'titre': 'parametrage des sites', 'valeur': 'site', 'action': 2},
            {'titre': 'parametrage des departements', 'valeur': 'deparement', 'action': 2},
            {'titre': 'parametrage des fonctions', 'valeur': 'fonction', 'action': 2},
            {'titre': 'parametrage des grades', 'valeur': 'grade', 'action': 2},
            {'titre': 'parametrage des frais', 'valeur': 'frais', 'action': 2},
            {'titre': 'parametrage des domaines', 'valeur': 'domaine', 'action': 2},
            {'titre': 'parametrage des lignes de service', 'valeur': 'ligne', 'action': 2},
            {'titre': 'parametrage des prestations', 'valeur': 'prestation', 'action': 1},
            {'titre': 'parametrage des charges', 'valeur': 'charge', 'action': 2},
        ]
    },
    {'module':'profils', 'valeur': "module_profil",
        'role':[
            {'titre': 'parametrage des profils', 'valeur':'profil', 'action': 2}
        ]
    },
    {'module': 'users', 'valeur': 'module_user',
        'role':[
            {'titre': 'visualisation des users', 'valeur':'user', 'action': 0},
    ...
    {'module': 'budget', 'valeur': 'module_budget',
        'role':[
            {'titre': 'visualisation des budgets collaborateurs en heure', 'valeur':'budget_userH', 'action': 1},
            {'titre': 'visualisation des budgets collaborateurs en valeur', 'valeur':'budget_userV', 'action': 0},
            {'titre': 'visualisation du budget des charges', 'valeur':'budget_charge', 'action': 1},
            {'titre': 'visualisation du budget des clients ', 'valeur': 'budget_client', 'action':  1}
        ]
    },
    {'module': 'clients', 'valeur': 'module_client',
        'role':[
            {'titre': 'visualisation des clients', 'valeur':'client', 'action': 2},
            {'titre': 'visualisation des contacts des clients', 'valeur':'client_contact', 'action': 2},
            {'titre': 'visualisation des contacts', 'valeur':'contact', 'action': 2},
            {'titre': 'visualisation du budget des clients ', 'valeur': 'client_budget', 'action': 0}
        ]
    },
    {'module': 'taches', 'valeur': 'module_tache',
        'role':[
            {'titre': 'visualisation des taches', 'valeur':'tache', 'action': 1},
            {'titre': 'visualisation des feuilles de temps des taches ', 'valeur':'tache_temps', 'action': 0},
            {'titre': 'visualisation des frais des taches ', 'valeur':'tache_frais', 'action': 0},
        ]
    },
    {'module': 'temps', 'valeur': 'module_temps',
        'role':[
            {'titre': 'visualisation des feuilles de temps globales', 'valeur':'temp', 'action': 0}
        ]
    },
    {'module': 'statistique', 'valeur': 'module_statistique',
        'role':[
            {'titre': 'visualisation des statistiques des feuilles de temps globales', 'valeur':'stat', 'action': 0}
        ]
    }
]
